...
const DATA_TYPES = [
  ...
  export default function ManageProviderAttributeTypes() {
    ...
    return (
        <Card>
          <CardHeader className="flex flex-wrap justify-between gap-4">
            <CardTitle>Provider Attribute Type Management</CardTitle>
            ...
            <div>
            <Button onClick={() => setModalOpen(true)} className='item-start'>+ Add Provider Attribute Type</Button>
            </div>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {attributeTypes.length > 0 ? (
                    ...
                    <TableCell colSpan={2} className="text-center py-6 text-gray-500">
                      No Provider attribute types found.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
        ...
        <Dialog open={modalOpen} onOpenChange={setModalOpen}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Add Provider Attribute Type</DialogTitle>
            </DialogHeader>
